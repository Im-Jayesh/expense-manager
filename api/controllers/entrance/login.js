...
and exposed as \`req.me\`.)`
  ...
  fn: async function ({emailAddress, password, rememberMe}) {
    ...
    const maxAge = rememberMe ? 30*24*60*60*1000 : 2*24*60*60*1000; // ms

    // set JWT as HttpOnly cookie (auto-sent by browser)
    ...
    // you can still return token if you want (optional)
    return { token };
  }
